class TiposController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo.save
        format.html { redirect_to @tipo, notice: 'Tipo de monitoria foi atualizado com sucesso.' }
  ...
  def destroy
    @tipo.destroy
    respond_to do |format|
      format.html { redirect_to tipos_url, notice: 'Tipo de monitoria foi removido com sucesso.' }
